...
//Get Nodo State
$app->get('/nodostate', function () use($app) {
...
//List events
$app->get('/events(/:nr)', function ($nr = 0) use($app) {
...
//List messages
$app->get('/messages(/:nr)', function ($nr = 0) use($app) {
...
//Get Nodo status
$app->get('/nodostatus', function () use($app){
...
//List graph data
$app->get('/graphdata/:id(/:interval)(/:type)', function ($id,$interval,$type) use($app) {
...
//Get alarms
$app->get('/alarms(/:alarmnr)', function ($alarmnr = 0) use($app){
...
//Get device state
$app->get('/devicestate', function () use($app) {
 try {
