...
<div data-role="page" pageid="main" data-theme="<?php echo $theme?>">
	...
	<form action="personal.php" data-ajax="false" method="post"> 
		    ...
		    <select name="theme" id="theme" data-placeholder="true" data-native-menu="false">
				<option value="b" <?php if ($row['webapp_theme'] == "b") {echo 'selected="selected"';}?>>Grey</option>
				<option value="a" <?php if ($row['webapp_theme'] == "a") {echo 'selected="selected"';}?>>White</option>
				<option value="c" <?php if ($row['webapp_theme'] == "c") {echo 'selected="selected"';}?>>Red</option>
				<option value="d" <?php if ($row['webapp_theme'] == "d") {echo 'selected="selected"';}?>>Orange</option>
				<option value="e" <?php if ($row['webapp_theme'] == "e") {echo 'selected="selected"';}?>>Black</option>
				<option value="f" <?php if ($row['webapp_theme'] == "f") {echo 'selected="selected"';}?>>F</option>
				<option value="g" <?php if ($row['webapp_theme'] == "g") {echo 'selected="selected"';}?>>G</option>
				<option value="h" <?php if ($row['webapp_theme'] == "h") {echo 'selected="selected"';}?>>H</option>
